...
class ContactRepositoryImpl @Inject constructor(
    ...
    override suspend fun syncContacts() {
        ...
        val entities = response.matchedContacts.map { matched ->
            ContactEntity(
                id = matched.userId,
    ...
    override suspend fun setFavorite(userId: String, favorite: Boolean) {
        contactDao.setFavorite(userId, favorite)
    }

    // ── Mapping helpers ──

    private fun ContactEntity.toDomain(): User = User(
        id = userId ?: id,
