...
class VaultRepositoryImpl
    ...
    constructor(
        ...
        private fun ProtoVaultItem.toDomain(): VaultItem =
            VaultItem(
                id = id,
        ...
        private fun categoryToVaultItemType(category: String): VaultItemType =
        ...
        private fun mimeTypeToCategory(mimeType: String): String =
            when {
