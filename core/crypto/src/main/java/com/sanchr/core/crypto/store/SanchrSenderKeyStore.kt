...
class SanchrSenderKeyStore
    ...
    constructor(
        ...
        private fun senderKeyKey(
            sender: SignalProtocolAddress,
            distributionId: UUID,
        ): String = "${sender.name}_${sender.deviceId}_$distributionId"

        private fun senderKeyFile(
            sender: SignalProtocolAddress,
            distributionId: UUID,
        ): File = File(senderKeyDir, "${sender.name}_${sender.deviceId}_$distributionId.bin")
    }
