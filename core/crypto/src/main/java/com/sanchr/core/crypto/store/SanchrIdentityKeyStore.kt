...
class SanchrIdentityKeyStore
    ...
    constructor(
        ...
        override fun getIdentityKeyPair(): IdentityKeyPair {
            val encoded =
                prefs.getString(KEY_IDENTITY_KEY_PAIR, null)
         ...
         */
        fun hasIdentityKeyPair(): Boolean = prefs.contains(KEY_IDENTITY_KEY_PAIR)
        ...
        override fun getIdentity(address: SignalProtocolAddress): IdentityKey? = loadRemoteIdentity(addressKey(address))
