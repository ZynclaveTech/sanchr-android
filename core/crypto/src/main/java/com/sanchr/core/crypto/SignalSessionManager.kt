...
class SignalSessionManager @Inject constructor(
     ...
     */
    suspend fun establishSession(userId: String, deviceId: Int): SessionBuilder {
     ...
     */
    suspend fun encrypt(plaintext: ByteArray, userId: String, deviceId: Int): EncryptResult {
        val address = SignalProtocolAddress(userId, deviceId)
    ...
    suspend fun encryptForAllDevices(
        ...
        val devicesResponse = com.sanchr.proto.keys.GetUserDevicesRequest(userId = recipientId)
     ...
     */
    fun resetSession(userId: String, deviceId: Int) {
        val address = SignalProtocolAddress(userId, deviceId)
