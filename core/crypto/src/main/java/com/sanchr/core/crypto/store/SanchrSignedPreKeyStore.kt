 ...
 */
@Singleton
class SanchrSignedPreKeyStore @Inject constructor(
    ...
    override fun containsSignedPreKey(signedPreKeyId: Int): Boolean {
        return cache.containsKey(signedPreKeyId) || signedPreKeyFile(signedPreKeyId).exists()
    }
    ...
    fun getNextSignedPreKeyId(): Int {
        val existingIds = signedPreKeyDir.listFiles()
    ...
    private fun signedPreKeyFile(signedPreKeyId: Int): File =
        File(signedPreKeyDir, "$signedPreKeyId.bin")
}
